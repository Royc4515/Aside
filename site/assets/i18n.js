...
(function () {
  ...
  const dict = {
    en: {
      ...
      "install.aside.s5.h": "Pin it & open the sidebar",
      "install.aside.s5.b": "Click the puzzle icon in the toolbar, pin Aside, then press Alt + A on any page.",
    ...
    he: {
      ...
      "install.aside.s5.h": "הצמידו לסרגל ופתחו את הסיידבר",
      "install.aside.s5.b": "לחצו על אייקון הפאזל בסרגל, הצמידו את Aside, ואז לחצו Alt + A בכל עמוד.",
