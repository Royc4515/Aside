...
(function () {
  ...
  const dict = {
    en: {
      ...
      "gallery.title": "Stays out of your way",
      "gallery.sub": "A sidebar that sits next to your work, not on top of it. No new tab, no full-screen takeover.",
    ...
    he: {
      ...
      "gallery.title": "לא מפריע, פשוט עוזר",
      "gallery.sub": "סיידבר שיושב לצד מה שאתם עושים — לא טאב חדש, לא חלון שמשתלט על המסך.",
