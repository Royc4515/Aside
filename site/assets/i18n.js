...
(function () {
  ...
  const dict = {
    en: {
      ...
      "feat.6.title": "Reply in eight languages",
      "feat.6.body": "The interface is English or Hebrew (full RTL); ask the model to reply in any of eight — English, Hebrew, Spanish, French, German, Chinese, Arabic, or Japanese.",
      ...
      "install.aside.s1.h": "Download Aside",
      "install.aside.s1.b": "Grab the slim aside.zip (~83 KB) and unzip it anywhere on your machine.",
      ...
      "install.aside.s4.b": "Click Load unpacked and select the unzipped aside folder (the one containing manifest.json).",
      ...
      "install.groq.note": "Groq runs OpenAI's open-weight GPT-OSS 120B at conversational speed and has a free tier — perfect for daily use. About 60 seconds.",
      ...
      "privacy.body": "Aside is 100% client-side. API keys live in chrome.storage.local — on your device only, never synced or uploaded anywhere. Requests go directly from your browser to the provider you chose. No telemetry, no analytics, no server in the middle.",
      ...
      "faq.a2": "In chrome.storage.local — on your device only. They are never synced, uploaded, or sent to any server (there is no server we control). Conversation history is stored locally only, too.",
      "faq.q6": "Can I choose which model each provider uses?",
      "faq.a6": "Yes. Each provider ships with a sensible default, and you can switch model right from the composer — or in Settings → Model — e.g. Claude Sonnet 5, Opus 5.5, or Haiku 4.5. There's also a Custom field to type any model id the provider supports, so you're never stuck waiting for us to add a new one. Custom ids are saved per provider, so they reappear under Saved custom for one-click reuse.",
      ...
      "faq.a4": "The interface ships in English and Hebrew (full RTL). You can ask the model to reply in any of eight languages: English, Hebrew, Spanish, French, German, Chinese, Arabic, and Japanese.",
    ...
    he: {
      ...
      "feat.6.title": "תשובות בשמונה שפות",
      "feat.6.body": "הממשק באנגלית או עברית (תמיכה מלאה ב-RTL); אפשר לבקש מהמודל לענות באחת משמונה — אנגלית, עברית, ספרדית, צרפתית, גרמנית, סינית, ערבית או יפנית.",
      ...
      "install.aside.s1.h": "הורידו את Aside",
      "install.aside.s1.b": "קחו את קובץ aside.zip הרזה (כ-83 KB) וחלצו אותו לכל מקום במחשב.",
      ...
      "install.aside.s4.b": "לחצו Load unpacked ובחרו את תיקיית aside שחילצתם (זו שמכילה את manifest.json).",
      ...
      "install.groq.note": "Groq מריצים את GPT-OSS 120B של OpenAI במהירות שיחה אמיתית, עם tier חינמי — מושלם לשימוש יומיומי. כ-60 שניות.",
      ...
      "privacy.body": "Aside פועל 100% בצד הלקוח. מפתחות API נשמרים ב-chrome.storage.local — על המכשיר שלכם בלבד, ללא סנכרון וללא העלאה לשום מקום. הבקשות נשלחות ישירות מהדפדפן אל הספק שבחרתם. ללא טלמטריה, ללא איסוף נתונים, ללא שרת באמצע.",
      ...
      "faq.a2": "ב-chrome.storage.local — על המכשיר שלכם בלבד. הם לא מסונכרנים, לא מועלים ולא נשלחים לאף שרת (פשוט כי אין לנו שרת). גם היסטוריית השיחות נשמרת מקומית בלבד.",
      "faq.q6": "אפשר לבחור איזה מודל כל ספק משתמש בו?",
      "faq.a6": "כן. לכל ספק יש מודל ברירת מחדל, ואפשר להחליף מודל ישירות מתיבת ההקלדה — או בהגדרות ← מודל — למשל Claude Sonnet 5, Opus 5.5 או Haiku 4.5. יש גם שדה Custom להקליד כל מזהה מודל שהספק תומך בו, כך שלעולם לא תהיו תקועים בהמתנה שנוסיף מודל חדש. מזהים מותאמים נשמרים לכל ספק ומופיעים מחדש תחת \"Saved custom\" לשימוש חוזר בלחיצה אחת.",
      ...
      "faq.a4": "הממשק מגיע באנגלית ובעברית (תמיכה מלאה ב-RTL). אפשר לבקש מהמודל לענות באחת משמונה שפות: אנגלית, עברית, ספרדית, צרפתית, גרמנית, סינית, ערבית ויפנית.",
