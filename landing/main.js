...
const STRINGS = {
  en: {
    ...
    'providers.intro': 'Add a key once in <strong>Settings → Provider</strong>. Aside checks it against the live API before saving. Switch any time, right from the sidebar.',
    ...
    'how.s3.p': 'The header dropdown swaps between Claude, Gemini, GPT-4o, Grok, Groq, and Ollama with one click. Each provider remembers your model choice.',
  ...
  he: {
    ...
    'providers.intro': 'הוסיפו מפתח פעם אחת ב-<strong>הגדרות → ספק</strong>. Aside מאמת אותו מול ה-API האמיתי לפני השמירה. החליפו בכל רגע — ישירות מהסרגל.',
    ...
    'faq.q2.a': 'המפתחות נשמרים באחסון המוצפן המקומי של Chrome במחשב שלכם, ונשלחים רק לספק שהנפיק אותם — ב-HTTPS. אין שרת Aside. אין שרת מתווך. אין אנליטיקס. אין טלמטריה. קראו את <a href="PRIVACY.html">מדיניות הפרטיות המלאה</a>.',
