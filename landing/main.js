...
const STRINGS = {
  en: {
    ...
    'hero.lede': 'Context-aware AI for any webpage. Summarize, extract, translate, or just chat — with the provider you choose.',
  ...
  he: {
    ...
    'meta.description': 'Aside הוא תוסף Chrome שמנגיש שישה ספקי AI — Claude, Gemini, GPT-4o, Grok, Groq ו-Ollama מקומי — בהקשה אחת, בכל דף.',
    ...
    'hero.lede': 'AI מודע לדף שאתם קוראים. סכמו, חלצו תובנות, תרגמו או פשוט שוחחו — עם הספק שאתם בוחרים.',
    'hero.cta.install': 'התקינו מ-GitHub',
    'hero.cta.howToInstall': '← איך מתקינים',
    'hero.cta.storeSoon': '<strong>בקרוב גם ב-Chrome Web Store</strong> · חינמי, רישיון MIT.',
    ...
    'features.h2': 'נבנה כדי להיטמע בזרימת העבודה שלכם.',
    'features.intro': 'אתם קוראים משהו — מאמר, מחקר, תיעוד API או שרשור מיילים ארוך — ואתם רוצים תשובה מ-AI <em>עכשיו</em>, בלי לעזוב את הדף.',
    ...
    'features.f2.p': 'Claude, Gemini, GPT-4o, Grok, Groq ו-Ollama מקומי — מחליפים בלחיצה, בלי התחברויות נפרדות.',
    'features.f3.h': 'קורא את הדף עבורכם',
    'features.f3.p': 'סיכום, נקודות מפתח, תרגום, חיפוש בדף או פרומפט מותאם אישית. בלי להעתיק ולהדביק.',
    ...
    'providers.intro': 'הוסיפו מפתח פעם אחת ב-<strong>הגדרות → ספק</strong>. Aside מאמת אותו מול ה-API האמיתי לפני השמירה. אפשר להחליף בכל רגע ישירות מהסרגל.',
    ...
    'how.s1.p': 'סרגל צד דק נפתח מימין (או משמאל — איך שתעדיפו). הוא כבר יודע את שפת הדף ואיזה טקסט סימנתם.',
    ...
    'how.s3.p': 'התפריט בכותרת הסרגל מחליף בין Claude, Gemini, GPT-4o, Grok, Groq ו-Ollama בלחיצה אחת. כל ספק זוכר איזה מודל בחרתם.',

    'privacy.kicker': 'פרטיות',
    'privacy.h2': 'המפתחות שלכם. המחשב שלכם. המידע שלכם.',
    'privacy.c1.h': 'המפתחות נשארים אצלכם',
    'privacy.c1.p': 'מפתחות ה-API נשמרים באחסון המקומי המוצפן של Chrome, ונשלחים רק לספק שבחרתם — ב-HTTPS בלבד.',
    ...
    'faq.q2.a': 'המפתחות נשמרים באחסון המוצפן המקומי של Chrome במחשב שלכם, ונשלחים רק לספק שהנפיק אותם — ב-HTTPS. אין שרת של Aside, אין שרת מתווך, אין אנליטיקס, אין טלמטריה. קראו את <a href="PRIVACY.html">מדיניות הפרטיות המלאה</a>.',
    ...
    'faq.q4.a': 'Aside הוא תוסף Manifest V3 ורץ על כל דפדפן מבוסס Chromium — Google Chrome, Microsoft Edge, Brave, Arc, Opera. תמיכה ב-Firefox מתוכננת ברגע שנשלים את התאמת ה-manifest.',
    ...
    'install.h2': 'שתי דרכים להתקנה. שתיהן בערך דקה.',
    'install.c1.h': 'Chrome Web Store',
    ...
    'install.c2.s3': 'לחצו <strong>טעינה לא ארוזה</strong> ובחרו את התיקייה המכילה את <code>manifest.json</code> (התיקייה <code>Aside-main</code> שחילצתם — לא תת-תיקייה שבתוכה).',
